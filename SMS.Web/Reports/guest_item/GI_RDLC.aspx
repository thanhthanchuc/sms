<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GI_RDLC.aspx.cs" Inherits="SMS.Web.Reports.guest_item.GI_RDLC" %>
    ...
    <form id="form1" runat="server">
        <<div style="width: 100%; display: flex">
            <div>
                <asp:Panel ID="Panel1" runat="server">
                    <asp:Label ID="Label1" runat="server" Text="Từ ngày" Font-Size="Medium"></asp:Label>
            ...
            <div>
                <asp:Panel ID="Panel2" runat="server">
                    <asp:Label ID="Label2" runat="server" Text="Đến ngày" Font-Size="Medium"></asp:Label>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <div>
                <asp:Label ID="Label3" runat="server" Text="Phòng ban" Font-Size="Medium"></asp:Label>
                &nbsp;<asp:TextBox ID="TextBox3" Width="120px" runat="server" Font-Size="Large"></asp:TextBox>
            </div>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <div>
                <asp:Label ID="Label4" runat="server" Text="Tên nhân viên" Font-Size="Medium"></asp:Label>
                &nbsp;<asp:TextBox ID="TextBox4" Width="150px" runat="server" Font-Size="Large"></asp:TextBox>
            </div>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <div>
                <asp:Label ID="Label6" runat="server" Text="Tên khách" Font-Size="Medium"></asp:Label>
                &nbsp;<asp:TextBox ID="TextBox5" Width="120px" runat="server" Font-Size="Large"></asp:TextBox>
            </div>
            &nbsp;&nbsp;&nbsp;
            <div>
                <asp:Label ID="Label7" runat="server" Text="Công ty" Font-Size="Medium"></asp:Label>
                &nbsp;<asp:TextBox ID="TextBox6" Width="120px" runat="server" Font-Size="Large"></asp:TextBox>
            </div>
            &nbsp;&nbsp;&nbsp;
            <div>
                <asp:CheckBox ID="CheckBox1" runat="server" />
                &nbsp;<asp:Label ID="Label5" runat="server" Text="Là khách nước ngoài" Font-Size="Medium"></asp:Label>
            </div>
            &nbsp;&nbsp;&nbsp;
            <div>
        ...
        <div style="z-index: -1; height: auto; width: 100%; overflow: auto">
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" BackColor="" ClientIDMode="AutoID" HighlightBackgroundColor="" InternalBorderColor="204, 204, 204" InternalBorderStyle="Solid" InternalBorderWidth="1px" LinkActiveColor="" LinkActiveHoverColor="" LinkDisabledColor="" PrimaryButtonBackgroundColor="" PrimaryButtonForegroundColor="" PrimaryButtonHoverBackgroundColor="" PrimaryButtonHoverForegroundColor="" SecondaryButtonBackgroundColor="" SecondaryButtonForegroundColor="" SecondaryButtonHoverBackgroundColor="" SecondaryButtonHoverForegroundColor="" SplitterBackColor="" ToolbarDividerColor="" ToolbarForegroundColor="" ToolbarForegroundDisabledColor="" ToolbarHoverBackgroundColor="" ToolbarHoverForegroundColor="" ToolBarItemBorderColor="" ToolBarItemBorderStyle="Solid" ToolBarItemBorderWidth="1px" ToolBarItemHoverBackColor="" ToolBarItemPressedBorderColor="51, 102, 153" ToolBarItemPressedBorderStyle="Solid" ToolBarItemPressedBorderWidth="1px" ToolBarItemPressedHoverBackColor="153, 187, 226" Width="100%" Height="794px">
                <LocalReport ReportPath="Reports\guest_item\ReportGI.rdlc">
                </LocalReport>
            </rsweb:ReportViewer>
        </div>
    </form>
